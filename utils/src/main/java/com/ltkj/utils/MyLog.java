...
//		}
	 ...
	 * @param content
	 */
	public static void errorWriteFile(String content){
		writeFileSdcard(content, 2);
	}
	 ...
	 * @param content
	 */
	public static void infoWriteFile(String content){
		writeFileSdcard(content, 1);
	}
	...
	private static void writeFileSdcard(String message, int type) {
		String tag = BaseApplication.getAppName();
